...
async function loadQAData() {
    try {
        ...
        console.warn('⚠️ Could not load JSON, using fallback responses:', error.message);
...
function getFallbackQAData() {
    return [
        ...
        response: "🗣️ Areen is fluent in both English and Arabic, allowing her to communicate complex technical concepts to global stakeholders seamlessly."
        },
        {
